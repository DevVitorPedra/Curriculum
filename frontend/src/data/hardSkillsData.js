export const HS = {
    gt:{
        ...
        content:`Na formação tive a oportunidade de desenvolver o conhecimentos na área de gestão  de todas as partes do turismo.
        Além das matérias específicas, também adquiri conhecimentos como gestão de projetos, empreendedorismo, administração, gestão de recursos e
        gestão de pessoas.`
    },
    sistemas:{
