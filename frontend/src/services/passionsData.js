export const PASSIONS   ={
    chess:{
        title:'CHESS',
        content:`Além de ser uma ótima ferramenta para exercitar o raciocínio lógico, o xadrez tem o poder de relaxar.
        Costumo jogar no mínimo 5 partidas por dia, conheci o jogo vendo meus irmãos mais velhos jogarem, mas eles já não tem mais chance contra mim.`
    },
    esportes:{
    ...
    musica:{
        title:'Música',
        content:`Sempre fui apaixonado música, das mais variadas, mas a trilha sonora do meu dia a dia varia entre rock e música clássica.
        Em casa tenho guitarra, baixo, violão, gaita de boca e um violino.
        Rammstein, Metallica, Pantera, Korn, Beethoven, Vivaldi, Tchaikovsky e Bach estão entre os meus favoritos.`
    }
}